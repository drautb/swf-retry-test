...
public final class SwfRetryTest {
  ...
  public static final String DECIDER_VERSION = "1.0.10";
  public static final String ACTIVITY_VERSION = "1.0.10";

  public static final int INITIAL_RETRY_INTERVAL_SECONDS = 30;
